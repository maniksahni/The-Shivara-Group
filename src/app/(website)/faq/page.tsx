...
import FAQAccordion from "@/app/(website)/faq/FAQAccordion";
        ...
        <div className="rounded-[2.4rem] border border-[#081120]/10 bg-white p-7 sm:p-12 shadow-sm">
          ...
          <div className="mt-12 rounded-2xl bg-[#081120] p-6 text-white text-center sm:p-8">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              <a href={siteConfig.phoneHref} className="inline-flex min-h-11 items-center gap-2 rounded-full bg-white px-6 text-xs font-bold uppercase tracking-wider text-[#081120]">
                <Phone className="h-4 w-4" />
                Call {siteConfig.phone}
              </a>
              <a href={siteConfig.whatsappHref} target="_blank" rel="noopener noreferrer" className="inline-flex min-h-11 items-center gap-2 rounded-full bg-[#10B981] px-6 text-xs font-bold uppercase tracking-wider text-white">
