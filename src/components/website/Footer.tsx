      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              Bareilly&apos;s most trusted real estate consultancy — helping
              families find their perfect homes since 2014. Built on transparency,
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:info@shivaragroup.com"
                  className="text-sm text-white/60 hover:text-[#C9A84C] transition-colors duration-200"
                >
                  info@shivaragroup.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-white/30 text-center">
            Real Estate Consultancy &amp; Property Services
          </p>
        </div>
      </div>
    </footer>
