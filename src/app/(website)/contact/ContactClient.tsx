            ...
            {submitted ? (
              <div className="rounded-[2rem] border border-[#10B981]/20 bg-[#ECFDF5] p-8 text-center">
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-3">
                  ...
                  <a
                    href={siteConfig.phoneHref}
                    className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#D4AF37] px-5 text-sm font-black uppercase tracking-[0.12em] text-[#081120]"
                  >
                    <Phone className="h-4 w-4" />
                    Call
                  </a>
                  <button
                    ...
                    className="min-h-12 rounded-full bg-[#081120] px-5 text-sm font-black uppercase tracking-[0.12em] text-white"
                  >
                    New Request
                  </button>
                </div>
